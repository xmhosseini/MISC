...
def Mobilenet_bottom():
    ...
    x = my_conv2d(inputs=x, my_filter = getCustomTensor(1, 1, 512, 512, 4, 1), filters=512, kernel_size=(1,1), strides=(1,1), padding='same', use_bias=False, kernel_initializer = 'glorot_uniform')
    x = BatchNormalization()(x)
    x = my_conv2d(inputs=x, my_filter = getCustomTensor(1, 1, 512, 512, 4, 4), filters=512, kernel_size=(1,1), strides=(1,1), padding='same', use_bias=False, kernel_initializer = 'glorot_uniform')
    x = BatchNormalization()(x)
    x = my_conv2d(inputs=x, my_filter = getCustomTensor(1, 1, 512, 512, 4, 16), filters=512, kernel_size=(1,1), strides=(1,1), padding='same', use_bias=False, kernel_initializer = 'glorot_uniform')
    x = BatchNormalization()(x)
    x = my_conv2d(inputs=x, my_filter = getCustomTensor(1, 1, 512, 512, 4, 64), filters=512, kernel_size=(1,1), strides=(1,1), padding='same', use_bias=False, kernel_initializer = 'glorot_uniform')
    x = BatchNormalization()(x)
    x = my_conv2d(inputs=x, my_filter = getCustomTensor(1, 1, 512, 512, 4, 128), filters=512, kernel_size=(1,1), strides=(1,1), padding='same', use_bias=False, kernel_initializer = 'glorot_uniform')
    x = BatchNormalization()(x)
    x = my_conv2d(inputs=x, my_filter = getCustomTensor(1, 1, 512, 512, 4, 1), filters=512, kernel_size=(1,1), strides=(1,1), padding='same', use_bias=False, kernel_initializer = 'glorot_uniform')
    x = BatchNormalization()(x)
    x = my_conv2d(inputs=x, my_filter = getCustomTensor(1, 1, 512, 512, 4, 4), filters=512, kernel_size=(1,1), strides=(1,1), padding='same', use_bias=False, kernel_initializer = 'glorot_uniform')
...
# smh: this rate seems to be degrated to 0.001 through the course of epochs
    x = my_conv2d(inputs=x, my_filter = getCustomTensor(1, 1, 512, 1000, 10, 1), filters=1000, kernel_size=(1,1), strides=(1,1), padding='same', use_bias=False, kernel_initializer = 'glorot_uniform')
    x = BatchNormalization()(x)
    x = my_conv2d(inputs=x, my_filter = getCustomTensor(1, 1, 1000, 1000, 10, 10), filters=1000, kernel_size=(1,1), strides=(1,1), padding='same', use_bias=False, kernel_initializer = 'glorot_uniform')
    x = BatchNormalization()(x)
    x = my_conv2d(inputs=x, my_filter = getCustomTensor(1, 1, 1000, 1000, 10, 100), filters=1000, kernel_size=(1,1), strides=(1,1), padding='same', use_bias=False, kernel_initializer = 'glorot_uniform')
    x = BatchNormalization()(x)
    x = my_conv2d(inputs=x, my_filter = getCustomTensor(1, 1, 1000, 1000, 10, 1), filters=1000, kernel_size=(1,1), strides=(1,1), padding='same', use_bias=False, kernel_initializer = 'glorot_uniform')
    x = BatchNormalization()(x)
    x = my_conv2d(inputs=x, my_filter = getCustomTensor(1, 1, 1000, 1000, 10, 10), filters=1000, kernel_size=(1,1), strides=(1,1), padding='same', use_bias=False, kernel_initializer = 'glorot_uniform')
    x = BatchNormalization()(x)
    x = my_conv2d(inputs=x, my_filter = getCustomTensor(1, 1, 1000, 1000, 10, 100), filters=1000, kernel_size=(1,1), strides=(1,1), padding='same', use_bias=False, kernel_initializer = 'glorot_uniform')
