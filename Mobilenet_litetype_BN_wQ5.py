...
if __name__ == '__main__':
    batch_size = 192
    inital_epoch = 140
    ds = '/rhome/morteza/ImageNet/ILSVRC2012/'
    ...
    x_val = np.load("/rhome/morteza/ImageNet/ILSVRC2012_RGB_cropped/val_npy/x_val.npy") # loaded as RGB
    x_val = preprocess(x_val) 
    
    y_val = np.load("/rhome/morteza/ImageNet/ILSVRC2012_RGB_cropped/val_npy/y_val.npy")
    ...
    keras_idx_to_name = {}
    f = open("/rhome/morteza/ImageNet/ILSVRC2012_RGB_cropped/val_npy/synset_words.txt","r")
    idx = 0
    for line in f:
        parts = line.split(" ")
